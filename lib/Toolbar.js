        ...
        return (
            <Root colors={gradientColor}>
                ...
                <Panel activeOpacity={1} onPress={e => this.show(false)}>
                    {status === 1 && <Touch activeOpacity={0.7} onPress={this.onPlay} style={{ borderRadius: 100 }}>
                        <IPlay source={PlayIcon} isFullscreen={isFullscreen} />
                    </Touch>}
                    {status === 2 && <Touch activeOpacity={0.7} onPress={this.onPause} style={{ borderRadius: 100 }}>
                        <IPlay source={PauseIcon} isFullscreen={isFullscreen} />
                    </Touch>}
                </Panel>
                <Footer>
